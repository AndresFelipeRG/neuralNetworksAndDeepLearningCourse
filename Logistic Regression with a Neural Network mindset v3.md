...
sh = train_set_x_orig.shape
sh2 =test_set_x_orig.shape
train_set_x_flatten = train_set_x_orig.reshape(sh[0],-1).T
test_set_x_flatten = test_set_x_orig.reshape(sh2[0],-1).T
### END CODE HERE ###
